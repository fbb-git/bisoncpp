...
PI s_productionInfo[] = 
{
     ...
     {264, 1}, //     7: exp -> VAR
     {264, 3}, //     8: exp -> VAR '=' exp
     {264, 4}, //     9: exp -> FNCT '(' exp ')'
     {264, 3}, //     10: exp -> exp '+' exp
     {264, 3}, //     11: exp -> exp '-' exp
     {264, 3}, //     12: exp -> exp '*' exp
     {264, 3}, //     13: exp -> exp '/' exp
     {264, 2}, //     14: exp -> '-' exp
     {264, 3}, //     15: exp -> exp '^' exp
     {264, 3}, //     16: exp -> '(' exp ')'
     {267, 1}, //     17: input_$ -> input
};
...
#line 51 "grammar"
        { 
                    d_val.u_val = *d_vsp[-2].u_symbol = d_vsp[0].u_val;
                }
        break;
...
#line 56 "grammar"
        { 
                    d_val.u_val = (*d_vsp[-3].u_fun)(d_vsp[-1].u_val); 
                }
        break;
...
#line 61 "grammar"
        { 
                    d_val.u_val = d_vsp[-2].u_val + d_vsp[0].u_val;
                }
        break;
...
#line 87 "grammar"
        { 
                    d_val.u_val = pow(d_vsp[-2].u_val, d_vsp[0].u_val);
                }
        break;
