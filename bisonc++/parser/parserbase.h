...
class SType: private std::unique_ptr<Base>
{
    ...
    public:
        ...
        void assign(Args &&...args);
            ...
            // don't match and thus far no errors were encounterd a run-time
            // fatal error results. 
        template <Tag__ tag>
...
// $insert debugdecl
        ...
        size_t vspIndex__() const;
        size_t state__() const;
        
        template<int field>
        auto const &stackEl__(size_t idx) const;
...
// hdr/top
inline ParserBase::StatePair &ParserBase::top(size_t idx) 
{
    return d_stateStack[d_stackIdx - idx];
}

inline ParserBase::StatePair const &ParserBase::top__() const
{
    return d_stateStack[d_stackIdx];
}

// hdr/msgidx
//inline size_t ParserBase::msgIdx__() const
//{
//    return top__<1>();
//}
//
//inline void ParserBase::msgIdx__(size_t idx)
//{
//    top__<1>() = idx;
//}
//
...
// hdr/vs
inline ParserBase::STYPE__ &ParserBase::vs__(size_t idx) 
{
