...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TypeOfBase<Tag__::SYMBOL>
    {
        typedef Symbol * DataType;
    };

    template <>
    struct TypeOfBase<Tag__::TERMINAL>
    {
    ...
    template <>
    struct TypeOfBase<Tag__::SIZE_T>
    {
        typedef size_t DataType;
    };

    template <>
    struct TypeOfBase<Tag__::BOOL>
    {
    ...
    struct TypeOf: public TypeOfBase<tg_>
    {
        ...
        typedef typename std::conditional<
                    sizeof(test<DataType>(0)) == sizeof(BuiltinType), 
...
template <Tag__ tg_>
inline typename TypeOf<tg_>::DataType &Semantic<tg_>::data()
{
    return d_data;
}
...
{
    return static_cast<Semantic<tg_> const *>(this)->data();
}
