...
PI__ const s_productionInfo[] = 
{
     ...
     {340, 1}, // 50: _typespec (':') ->  ':'
     {341, 4}, // 51: _polyspec (';') ->  identifier _typespec identifier ';'
     {342, 2}, // 52: _polyspecs ->  _polyspecs _polyspec
...
#line 240 "inc/directives"
        {
         addPolymorphic(d_vsp__[-3]->as<Tag::STRING>(), d_vsp__[-1]->as<Tag::STRING>());
         }
        break;
